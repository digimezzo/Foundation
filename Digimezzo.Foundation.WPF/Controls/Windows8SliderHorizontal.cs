...
{
    public class Windows8SliderHorizontal : SliderBase
    {
        static Windows8SliderHorizontal()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(Windows8SliderHorizontal), new FrameworkPropertyMetadata(typeof(Windows8SliderHorizontal)));
        }
